        ...
        <Container>
            <div className={"Profile"}>
                <div className="top-profile">
                    <Avatar variant={"rounded"} src={require("../assets/img/persona.png")}
                    ...
                    <div className="profile-detail">
                        ...
                        <span className={"profile-playlist"}>
                            <SideBarOptions className={"lib-sub"} Icon={PlaylistPlay}
                                            href={"/home/playlist/Gaming"} title={"Gaming"}/>
                            <SideBarOptions className={"lib-sub"} Icon={PlaylistPlay} href={"/home/playlist/Chill"}
                                            title={"Chill"}/>
                        </span>
                    </div>
                </div>
