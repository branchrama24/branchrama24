...
export const questions = [
	...
	},
	{
		...
		category: filosofia,
		correct_answer: 'Sócrates',
		incorrect_answers: ['Platón', 'Aristóteles', 'Heráclito'],
	},
	{
		id: 86,
		difficulty: 'Fácil',
		question:
			'¿Cuál de las siguientes teorías éticas se basa en el principio de maximizar la felicidad de la mayoría?',
		category: filosofia,
		correct_answer: 'Utilitarismo',
		incorrect_answers: ['Virtud ética', 'Ética del deber', 'Deontología'],
	},
	{
		id: 87,
		difficulty: 'Medio',
		question:
			'¿Qué filósofo alemán es conocido por su teoría del "Übermensch" o "Superhombre"?',
		category: filosofia,
		correct_answer: 'Friedrich Nietzsche',
		incorrect_answers: ['Martin Heidegger', 'Immanuel Kant', 'Arthur Schopenhauer'],
	},
	{
		id: 88,
		difficulty: 'Medio',
		question:
			'¿Cuál de las siguientes corrientes filosóficas se centra en la relación entre el lenguaje y la realidad, y fue desarrollada por Ludwig Wittgenstein?',
		category: filosofia,
		correct_answer: 'Positivismo lógico',
		incorrect_answers: ['Fenomenología', 'Estructuralismo', 'Empirismo lógico'],
	},
	{
		id: 89,
		difficulty: 'Medio',
		question:
			'¿En qué obra filosófica importante se argumenta la "Alegoría de la Caverna"?',
		category: filosofia,
		correct_answer: ' "La República" de Platón',
		incorrect_answers: ['"Ética a Nicómaco" de Aristóteles', '"Meditaciones" de Marco Aurelio', ' "Así habló Zaratustra" de Nietzsche'],
	},
	{
		id: 90,
		difficulty: 'Difícil',
		question:
			'¿Cuál de las siguientes ramas de la filosofía se ocupa del estudio de la moral y los valores?',
		category: filosofia,
		correct_answer: ' Ética',
		incorrect_answers: ['Epistemología', 'Ontología', 'Estética'],
	},
	{
		id: 91,
		difficulty: 'Difícil',
		question:
			'¿Qué filósofo existencialista escribió "El ser y la nada" y abordó temas como la libertad y la angustia?',
		category: filosofia,
		correct_answer: 'Jean-Paul Sartre',
		incorrect_answers: ['Albert Camus', 'Simone de Beauvoir', 'Friedrich Nietzsche'],
	},
	{
		id: 92,
		difficulty: 'Fácil',
		...
		category: historia,
		correct_answer: 'Bernardino Rivadavia',
		incorrect_answers: [
			'Manuel Belgrano',
			'Juan Domingo Perón',
			'Jose de San Martin',
	...
	},
	{
		id: 93,
		difficulty: 'Fácil',
		question: '¿Quién fue la figura central en la lucha por la independencia argentina y lideró el cruce de los Andes?',
		category: historia,
	...
	},
	{
		id: 94,
		difficulty: 'Fácil',
		question: '¿En qué año se firmó la Constitución Nacional de Argentina?',
		category: historia,
		correct_answer: '1853',
		incorrect_answers: [
			'1862',
	...
	},
	{
		...
		difficulty: 'Medio',
		question:
			'¿Quién fue la figura central en la lucha por la independencia argentina y lideró el cruce de los Andes?',
		category: historia,
		correct_answer: 'José de San Martín',
		incorrect_answers: ['Juan Manuel de Rosas', 'Juan Domingo Perón', 'Ninguno'],
	},
	{
		id: 96,
		difficulty: 'Medio',
	...
	},
	{
		...
		difficulty: 'Medio',
		question:
			'¿Qué presidente argentino fue conocido por su política de "La Roca" y por su papel en la obtención de la Patagonia?',
		category: historia,
		correct_answer: 'Julio Argentino Roca',
		incorrect_answers: ['Carlos Menem', 'Raúl Alfonsín', 'Leopoldo Galtieri'],
	},
	{
		id: 98,
		difficulty: 'Medio',
		question:
			'¿Qué período de la historia argentina se conoce como la "Década Infame"?',
		category: historia,
		correct_answer: '1930-1943',
		incorrect_answers: ['1880-1890', '1946-1955', '1976-1983'],
	},
	{
		id: 99,
		difficulty: 'Difícil',
		question:
			'¿Qué conflicto bélico enfrentó a Argentina con el Reino Unido en 1982?',
		category: historia,
		correct_answer: 'Guerra de Malvinas',
		incorrect_answers: ['Guerra de la Triple Alianza', 'Guerra de la Independencia', 'Guerra del Paraguay'],
	},
	{
		id: 100,
		difficulty: 'Difícil',
		question:
			'¿Qué importante figura política argentina fue conocida como "El Padre de la Patria"?',
		category: historia,
		correct_answer: 'José de San Martín',
		incorrect_answers: ['Carlos Menem', ' Manuel Belgrano', 'Domingo Faustino Sarmiento'],
	},
	{
		id: 101,
		difficulty: 'Difícil',
		question:
			'¿Quién es el único nadador en la historia en ganar ocho medallas de oro en una sola edición de los Juegos Olímpicos?',
		category: deportes,
		correct_answer: 'Michael Phelps',
		incorrect_answers: ['Ian Thorpe', 'Mark Spitz', 'Ryan Lochte'],
	},
	{
		id: 102,
		difficulty: 'Difícil',
		...
		category: deportes,
		correct_answer: '1896',
		incorrect_answers: ['1900', '1924', '1886'],
	},
	{
		id: 103,
		difficulty: 'Difícil',
		question:
			'¿Quién es considerado el mejor jugador de ajedrez de todos los tiempos y es campeón mundial desde 2007?',
		category: deportes,
		correct_answer: 'Magnus Carlsen',
		incorrect_answers: ['Garry Kasparov', 'Bobby Fischer', 'Anatoly Karpov'],
	},
	{
		id: 104,
		difficulty: 'Medio',
		question:
			'¿Cuál es el país de origen de la artista del tenis Serena Williams?',
		category: deportes,
		correct_answer: 'Estados Unidos',
		incorrect_answers: ['Australia', 'España', 'Suiza'],
	},
	{
		id: 105,
		difficulty: 'Medio',
		question:
			'¿En qué deporte se utiliza una tabla y una vela para deslizarse sobre el agua?',
		category: deportes,
		correct_answer: 'Windsurf',
		incorrect_answers: ['Natación sincronizada', 'Piragüismo', 'Surf'],
	},
	{
		id: 106,
		difficulty: 'Medio',
		question:
			'¿En qué deporte un luchador intenta inmovilizar a su oponente durante un tiempo determinado?',
		category: deportes,
		correct_answer: 'Lucha libre',
		incorrect_answers: ['Esgrima', 'Judo', 'Taekwondo'],
	},
	{
		id: 107,
		difficulty: 'Fácil',
		question:
			'¿En qué deporte se anota un touchdown?',
		category: deportes,
		correct_answer: 'Fútbol americano',
		incorrect_answers: ['Baloncesto', 'Tenis', 'Fútbol'],
	},
	{
		id: 108,
		difficulty: 'Fácil',
		question:
			'¿Qué deporte se juega en una cancha de hielo y utiliza una piedra de granito?',
		category: deportes,
		correct_answer: 'Curling',
		incorrect_answers: ['Hockey sobre hielo', 'Patinaje artístico', 'Esquí alpino'],
	},
	{
		id: 109,
		difficulty: 'Fácil',
		question:
			'¿En qué deporte se utiliza una red y una pelota amarilla?',
		category: deportes,
		correct_answer: 'Tenis',
		incorrect_answers: ['Voleibol', 'Golf', 'Bádminton'],
	},
	{
		id: 110,
		difficulty: 'Fácil',
		...
		category: geografia,
		correct_answer: 'Nilo',
		incorrect_answers: ['Yangtsé', 'Amazonas', 'Yangtsé'],
	},
	{
		id: 111,
		difficulty: 'Fácil',
		...
		category: geografia,
		correct_answer: 'Rusia',
		incorrect_answers: ['Canadá', 'Estados Unidos', 'China'],
	},
	{
		id: 112,
		difficulty: 'Fácil',
		...
		category: geografia,
		correct_answer: 'Roma',
		incorrect_answers: ['Atenas', 'Paris', 'Madrid'],
	},
	{
		id: 113,
		difficulty: 'Medio',
		question:
			'¿Cuál es el punto más alto de la Tierra, la montaña más alta?',
		category: geografia,
		correct_answer: 'Everest',
		incorrect_answers: ['Kilimanjaro', 'Aconcagua', 'Mont Blanc'],
	},
	{
		id: 114,
		difficulty: 'Medio',
		question:
			'¿Cuál es el país que comparte la península ibérica con España?',
		category: geografia,
		correct_answer: 'Portugal',
		incorrect_answers: ['Grecia', 'España', 'Suiza'],
	},
	{
		id: 115,
		difficulty: 'Medio',
		question:
			'¿Cuál de los siguientes países no tiene una frontera con Rusia?',
		category: geografia,
		correct_answer: 'Noruega',
		incorrect_answers: ['Polonia', 'Mongolia', 'Ucrania'],
	},
	{
		id: 116,
		difficulty: 'Difícil',
		question:
			'¿Cuál de los siguientes países se encuentra en el hemisferio sur, cerca del Polo Sur?',
		category: geografia,
		correct_answer: 'Australia',
		incorrect_answers: ['Noruega', 'Alaska', 'Argentina'],
	},
	{
		id: 117,
		difficulty: 'Difícil',
		question:
			'¿Cuál de las siguientes islas es conocida como la "Isla Esmeralda" debido a su exuberante vegetación?',
		category: geografia,
		correct_answer: 'Irlanda',
		incorrect_answers: ['Islas Canarias', 'Hawai', 'Nasau'],
	},
	{
		id: 118,
		difficulty: 'Difícil',
		question:
			'¿Cuál es el nombre del estrecho que separa Rusia de Alaska?',
		category: geografia,
		correct_answer: 'Estrecho de Bering',
		incorrect_answers: ['Estrecho de Magallanes', 'Estrecho de Gibraltar', 'Estrecho de Magallanes'],
	},
	{
		id: 119,
		difficulty: 'Difícil',
		question:
			'¿Qué autor ruso escribió la novela "Guerra y paz" que narra la vida en la Rusia de la época de Napoleón?',
		category: literatura,
		correct_answer: 'Leo Tolstoy',
		incorrect_answers: ['Fyodor Dostoevsky', 'Vladimir Nabokov', 'Anton Chekhov'],
	},
	{
		id: 120,
		difficulty: 'Difícil',
		question:
			'¿Qué escritor colombiano ganó el Premio Nobel de Literatura en 1982 y es conocido por su obra "Crónica de una muerte anunciada"?',
		category: literatura,
		correct_answer: 'Gabriel García Márquez',
	...
	},
	{
		...
		difficulty: 'Difícil',
		question:
			'¿Cuál es el nombre del protagonista y narrador en la novela "En busca del tiempo perdido" de Marcel Proust?',
		category: literatura,
		correct_answer: 'Marcel',
		incorrect_answers: ['Stephen Dedalus', 'Holden Caulfield', 'Leopold Bloom'],
	},
	{
		id: 122,
		difficulty: 'Difícil',
		question:
			'¿Quién escribió la novela "Cien años de soledad", una obra que se considera un hito en la literatura latinoamericana?',
		category: literatura,
		correct_answer: 'Gabriel García Márquez',
		incorrect_answers: ['Julio Cortázar', 'Mario Vargas Llosa', 'Jorge Luis Borges'],
	},
	{
		id: 123,
		difficulty: 'Difícil',
		question:
			'¿Cuál de las siguientes obras fue escrita por James Joyce y es conocida por su estilo narrativo experimental y complejo?',
		category: literatura,
		correct_answer: '"Ulises"',
		incorrect_answers: ['"1984"', '"En el camino"', '"Matar a un ruiseñor"'],
	},
	{
		id: 124,
		difficulty: 'Difícil',
		question:
			'¿Quién es el autor de la novela "El Gran Gatsby", una obra clásica de la literatura estadounidense que se desarrolla en la era del jazz en los años 20?',
		category: literatura,
	...
	},
	{
		...
		difficulty: 'Difícil',
		question:
			'¿Cuál de las siguientes óperas fue compuesta por Giuseppe Verdi y está ambientada en el antiguo Egipto?',
		category: musica,
		correct_answer: 'Aida',
		incorrect_answers: ['Carmen', 'La Traviata', 'Nilo'],
	},
	{
		id: 126,
		difficulty: 'Difícil',
		question:
			'¿Cuál de los siguientes compositores austriacos es conocido por su obra "Carmina Burana" y su estilo musical neoclásico?',
		category: musica,
		correct_answer: 'Carl Orff',
		incorrect_answers: ['Richard Strauss', 'Anton Butcher', 'Gustav Mahler'],
	},
	{
		id: 127,
		difficulty: 'Difícil',
		question:
			'¿Cuál de los siguientes artistas es un virtuoso del violín y es famoso por sus composiciones clásicas como "Las Cuatro Estaciones"?',
		category: musica,
		correct_answer: 'Antonio Vivaldi',
		incorrect_answers: ['Wolfgang Amadeus Mozart', 'Johann Strauss II', ' Ludwig van Beethoven'],
	},
	{
		id: 128,
		difficulty: 'Medio',
		question:
			'¿Cuál de los siguientes compositores es conocido por sus obras románticas, como "El lago de los cisnes" y "La bella durmiente"?',
		category: musica,
		correct_answer: 'Piotr Ilich Chaikovski',
	...
	},
	{
		...
		difficulty: 'Medio',
		question:
			'¿Qué género musical, originario de Jamaica, se caracteriza por su ritmo distintivo y letras de conciencia social?',
		category: musica,
		correct_answer: 'Reggae',
		incorrect_answers: ['Salsa', 'Phonk', 'Ska'],
	},
	{
		id: 130,
		difficulty: 'Medio',
		question:
			'¿Quién es conocido como "El Rey del Pop" y es uno de los artistas más influyentes en la historia de la música?',
		category: musica,
		correct_answer: 'Michael Jackson',
		incorrect_answers: ['Prince', 'David Bowie', 'Elvis Presley'],
	},
	{
		id: 131,
		difficulty: 'Medio',
		question:
			'¿Cuál de las siguientes bandas de rock se formó en la década de 1970 y es famosa por su álbum "The Wall"?',
		category: musica,
		correct_answer: 'Pink Floyd',
		incorrect_answers: ['Queen', 'Led Zeppelin', 'The Rolling Stones'],
	},
	{
		id: 132,
		difficulty: 'Fácil',
		question:
			'¿Cuál de estos instrumentos de viento-metal es conocido por su tono brillante y se usa comúnmente en el jazz?',
		category: musica,
		correct_answer: 'Trompeta',
		incorrect_answers: ['Saxofon', 'Trombon', 'Violonchelo'],
	},
	{
		id: 133,
		difficulty: 'Fácil',
		question:
			'¿Qué famoso cuarteto de Liverpool cambió para siempre la música popular en la década de 1960?',
		category: musica,
		correct_answer: 'The Beatles',
		incorrect_answers: ['The Who', 'The Beach Boys', 'The Rolling Stones'],
	},
	{
		id: 134,
		difficulty: 'Fácil',
		question:
			'¿Cuál de los siguientes géneros musicales se caracteriza por el uso de la guitarra eléctrica y la batería, y a menudo presenta letras melancólicas?',
		category: musica,
		correct_answer: 'Rock',
		incorrect_answers: ['Jazz', 'Reggae', 'Hip-Hop'],
	},
	
	{
		...
		difficulty: 'Difícil',
		question:
			'¿En qué juego de estrategia se representan ejércitos en miniatura y se juegan batallas en un campo de batalla?',
		category: juegos,
		correct_answer: 'Warhammer 40,000',
		incorrect_answers: ['Doom', 'Axis & Allies', 'BlazBlue'],
	},
	{
		id: 136,
		difficulty: 'Difícil',
		question:
			'¿Qué juego de video de aventuras y puzles lanzado en 2007 se desarrolla en la ciudad subterránea de Rapture?',
		category: juegos,
		correct_answer: 'Bioshock',
		incorrect_answers: ['Team Fortress', 'Portal', 'Half-Life 3'],
	},
	{
		id: 137,
		difficulty: 'Difícil',
		question:
			'En el mundo de "Dark Souls," ¿cuál de las siguientes afirmaciones es cierta sobre el personaje Solaire of Astora?',
		category: juegos,
		correct_answer: 'Amigo adorador del sol',
		incorrect_answers: ['Enemigo poderoso a derrotar', 'Antagonista principal a vencer', 'Amigo adorador de la luna'],
	},
	{
		id: 138,
		difficulty: 'Medio',
		question:
			'En el ajedrez, ¿qué pieza puede moverse en forma de "L" y saltar por encima de otras piezas?',
		category: juegos,
		correct_answer: 'Caballo',
		incorrect_answers: ['Torre', 'Reina', 'Dama'],
	},
	{
		id: 139,
		difficulty: 'Medio',
		question:
			'¿Cuál es el objetivo del juego de mesa "Risk"?',
		category: juegos,
		correct_answer: 'Conquistar territorios y derrotar a tus oponentes',
		incorrect_answers: ['Recoger tesoros en una isla desierta', 'Acumular propiedades inmobiliarias', 'Completar palabras con fichas de letras'],
	},
	{
		id: 140,
		difficulty: 'Medio',
		question:
			'En el juego de video "The Legend of Zelda," ¿cuál es el nombre del protagonista que lleva una espada y un escudo?',
		category: juegos,
		correct_answer: 'Link',
		incorrect_answers: ['Zelda', 'Hylian', 'Estalfo'],
	},
	{
		id: 141,
		difficulty: 'Medio',
		question:
			'¿Cuál es el juego de mesa en el que los jugadores compran y venden propiedades inmobiliarias, y el objetivo es hacer que los oponentes se queden sin dinero?',
		category: musica,
		correct_answer: 'Monopoly',
		incorrect_answers: ['Scrabble', 'Jenga', 'Clue'],
	},
	{
		id: 142,
		difficulty: 'Fácil',
		question:
			'¿En qué juego de mesa se intenta hundir los barcos del oponente antes de que los tuyos sean hundidos?',
		category: juegos,
		correct_answer: 'Batalla Naval',
		incorrect_answers: ['Ajedrez', 'Damas', 'Shogi'],
	},
	{
		id: 143,
		difficulty: 'Fácil',
		question:
			'¿Cuál es el juego de cartas en el que el objetivo es acumular 21 puntos sin pasarse?',
		category: juegos,
		correct_answer: 'Blackjack',
		incorrect_answers: ['Poker', 'Bridge', 'Solitario'],
	},
	{
		id: 144,
		difficulty: 'Fácil',
		question:
			'En el juego de video "Super Mario Bros.", ¿cuál es el nombre del personaje principal que debe rescatar a la princesa Peach?',
		category: juegos,
		correct_answer: 'Mario',
		incorrect_answers: ['Zelda', 'Luigi', 'Wario'],
	},
];