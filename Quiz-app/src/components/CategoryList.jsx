...
export const CategoryList = () => {
	return (
		<div className='flex flex-row flex-wrap justify-center gap-5	 mt-10'>
			...
			/>
			{/* Category Link Musica */}
			<CategoryCard
				category={categories.musica}
				src={imgMusica}
				alt={`Categoría ${categories.musica}`}
				gradientColor='from-blue-100 to-black-900 '
			/>
			{/* Category Link Musica */}
			<CategoryCard
				category={categories.juegos}
				src={imgJuegos}
				alt={`Categoría ${categories.juegos}`}
				gradientColor='from-blue-400 to-emerald-900 '
			/>
		</div>
	);
};
